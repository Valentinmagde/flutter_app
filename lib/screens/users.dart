...
import 'package:material_kit_flutter/screens/user_details.dart';
...
class _UsersPageState extends State<UsersPage>
{
  ...
  Widget build(BuildContext context)
  {
    return Scaffold
      ...
      drawer: MaterialDrawer(currentPage: "Utilisateurs"),
                    ...
                    child: Material
                      ...
                      borderRadius: BorderRadius.only
                        ...
                        child: InkWell
                          ...
                          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => UserDetailsPage())),
                          child: Padding(
                                  ...
                                  child: Column(
                                      children: [
                                        ListTile
                                          ...
                                          title: Text('L.M. Guiamatsia', style: TextStyle()),
                                          subtitle: Text(
                                              '''
                                          lm@intekor.ca
                                          +18472712357
                              ...
                              child: Column(
                                  children: [
                                    ListTile
                                      ...
                                      title: Text('E.D Cesaire', style: TextStyle()),
                                      subtitle: Text(
                                          '''
